...
exports = module.exports = internals.Connection = function (options) {
  ...
  // Some ugliness here as the options dict is passed directly to the dynamo constructor
  this.callSettings = {};
  if ('consistentRead' in options) {
    this.callSettings.consistentRead = options.consistentRead;
    delete this.settings.consistentRead;
  }
  else this.callSettings.consistentRead = false;
...
internals.Connection.prototype.get = function (key, callback) {
  ...
  if (this.callSettings.consistentRead) getOptions.ConsistentRead = true;

  this.service.getItem(getOptions, function (err, data) {
